...
a <- "https://depmap.org/portal/download/api/download/external?file_name=processed_portal_downloads%2Fdepmap-public-cell-line-metadata-183e.4%2FDepMap-2019q1-celllines_v2.csv"
depmap_19Q1_cell_lines <- read_csv(a)
...
### loading data (downloading .csv file from online source)
b <- "https://depmap.org/portal/download/api/download/external?file_name=ccle%2Fdepmap-mutation-calls-9a1a.9%2Fdepmap_19Q1_mutation_calls_v2.csv"
depmap_19Q1_mutation_calls <- read_csv(b)
...
### loading data (downloading .csv file from online source)
c <- "https://depmap.org/portal/download/api/download/external?file_name=ccle%2Fdepmap-wes-cn-data-97cc.14%2Fpublic_19Q1_gene_cn.csv"
public_19Q1_gene_cn  <- read_csv(c)
...
### rearrange columns into same column format as other datasets
copyNumber_19Q1 <- copyNumber_19Q1 %>% select(depmap_id, gene, log_copy_number,
...
### loading data (downloading .csv file from online source)
d <- "https://ndownloader.figshare.com/files/14221385"
gene_effect_corrected <- read_csv(d)
...
### loading data (downloading .csv file from online source)
e <- "https://depmap.org/portal/download/api/download/external?file_name=ccle%2Fdepmap-rnaseq-expression-data-ccd0.12%2FCCLE_depMap_19Q1_TPM.csv"
CCLE_depMap_19Q1_TPM  <- read_csv(e)
...
### loading data (downloading .csv file from online source)
g <- "https://depmap.org/portal/download/api/download/external?file_name=ccle%2FCCLE_RPPA_20180123.csv"
CCLE_RPPA_20180123  <- read_csv(g)
