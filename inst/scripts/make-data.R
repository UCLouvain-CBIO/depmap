...
##########################################
## `depmap_id_to_name` map `depmap_id` to `cell_line`
##########################################

##  generation of `metadata` subset `depmap_id_to_name`

## The subset of `metadata`, `depmap_id_to_name` is used to map `cell_line` and
## depmap_id via left_join in other depmap datasets that do not contain both. If
## you are generating the depmap data from scratch, you will need to run the
## following code to generate the data correctly.
...
##########################################
## EH502 depmap `mutationCalls` dataset
##########################################
...
##########################################
## EH503 depmap `copyNumber` dataset
##########################################
