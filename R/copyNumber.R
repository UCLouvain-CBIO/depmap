#' copyNumber_20Q2
#'
#' The `copyNumber` dataset contains the 20Q2 WES copy number data for genes and
#' cancer cell lines. This dataset includes data from 27639 genes, 1745 cell
...
#'
#' @format A data frame with 48230055 rows (cell lines) and 6 variables.
#'
#' \describe{
...
#'
#' @aliases copyNumber_20Q2 copyNumber_20Q1 copyNumber_19Q4 copyNumber_19Q3
