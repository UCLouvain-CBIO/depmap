#' crispr_19Q1
#'
#' The `crispr` dataset contains the 19Q1 genetic dependency of CRISPR-Cas9 gene
#' knockout of select genes in various cancer cell lines. This dataset includes
#' data from 17634 genes, 558 cell lines, 26 primary diseases and 28 lineages.
...
#' @rdname crispr
#'
#' @aliases crispr_19Q1 crispr_19Q2
crispr <- NULL
