#' mutationCalls_19Q1
#'
#' The `mutationCalls` dataset contains merged the 19Q1 mutation calls (for
#' coding region, germline filtered) and includes data from 18755 genes, 1601
...
#'
#' @aliases mutationCalls_19Q1 mutationCalls_19Q2
mutationCalls <- NULL
