...
#' \describe{
#'      \item{depmap_id}{cancer cell line foreign key (i.e. "ACH-000956")}
#'      \item{cell_line}{CCLE name of cancer cell line (i.e. "22RV1_PROSTATE")}
...
#'      \item{expression}{Log fold scale (log2(TPM+1)) protein expression in 
