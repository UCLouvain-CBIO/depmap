#' TPM_20Q3
#'
#' The `TPM` dataset contains the 20Q3 CCLE "Transcript Per Million" RNAseq gene
#' expression data for protein coding genes. This dataset includes data from
#' 19144 genes, 1305 cell lines, 32 primary diseases and 34 lineages. The
...
#'
#' @format A data frame with 24982920 rows (cell lines) and 6 variables:
#' \describe{
...
#' from the 20Q3 [Broad Institute](https://depmap.org/portal/download/) cancer
...
#' @rdname TPM
#'
#' @aliases TPM_20Q3 TPM_20Q2 TPM_20Q1 TPM_19Q4 TPM_19Q3 TPM_19Q2 TPM_19Q1
#' depmap_TPM
#' 
TPM <- NULL