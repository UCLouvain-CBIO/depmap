#' crispr_20Q2
#'
#' The `crispr` dataset contains the 20Q2 genetic dependency of CRISPR-Cas9 gene
#' knockout of select genes in various cancer cell lines. This dataset includes
#' data from 18119 genes, 769 cell lines, 29 primary diseases and 26 lineages.
...
#' release.
#'
#' @format A data frame with 13933511 rows (cell lines) and 6 variables:
#' \describe{
...
#' the 20Q2 [Broad Institute](https://depmap.org/portal/download/) cancer
...
#' @rdname crispr
#'
#' @aliases crispr_20Q2 crispr_20Q1 crispr_19Q4 crispr_19Q3 crispr_19Q2
#' crispr_19Q1 depmap_crispr
#' 
crispr <- NULL