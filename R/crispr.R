#' crispr_21Q2
#'
#' The `crispr` dataset contains the 21Q2 genetic dependency of CRISPR-Cas9 gene
#' knockout of select genes in various cancer cell lines. This dataset includes
#' data from 17645 genes, 990 cell lines, 32 primary diseases and 30 lineages.
...
#' release.
#'
#' @format A data frame with 17468550 rows (cell lines) and 6 variables:
#' \describe{
...
#' the 21Q2 [Broad Institute](https://depmap.org/portal/download/) cancer
...
#' @rdname crispr
#'
#' @aliases crispr_21Q2 crispr_21Q1 crispr_20Q4 crispr_20Q3 crispr_20Q2
#' crispr_20Q1 crispr_19Q4 crispr_19Q3 crispr_19Q2 crispr_19Q1 depmap_crispr
#' 
crispr <- NULL