...
most `r depmap_release()` depmap release and includes `r length(unique(rnai$gene))`
...
genes, `r length(unique(crispr$cell_line))` cell lines, 26 primary diseases, 28 lineages.
