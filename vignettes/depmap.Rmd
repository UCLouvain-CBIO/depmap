...
grid.arrange(p1, p2, p3, p4, nrow = 2, 
             top = "20 Genes with Highest and Lowest Dep Score for CRISPR and RNAI")
```

Compare expression of high and low dep score genes for `crispr` and `rnai` 
datasets.
...
grid.arrange(p5, p6, p7, p8, nrow = 2, 
             top = "Count of 50 Genes with Highest and Lowest Dep Score for CRISPR and RNAI")
```
...
p9 <- ggplot(all_LCN_Gene_CopyNum) + 
    aes(x=gene, y=mean_log_CN, color = mean_log_CN) +
    geom_point() +  scale_colour_viridis() +
...
################## this is where I am at with coding right now #################
