...
ggplot(byDepIdPIK3C3) + aes(byDepIdPIK3C3$crisprPIK3C3, byDepIdPIK3C3$rnaiPIK3C3, color = byDepIdPIK3C3$rnaiPIK3C3) + 
    geom_point() +  scale_colour_viridis() + 
    labs(y = "CRISPR Dependency Score", x = "RNAI Dependency Score") + 
    ggtitle("Dependency scores for RNAi vs PIK3C3 for PIKC3C") 
